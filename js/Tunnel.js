    ...
    monsterSwitch(){
        switch (this.monster){
            ...
            case 2 : monster = new Monster(this.body.x -10,this.body.y,2);
                     ...
                     break; 
            case 3 : monster = new Monster(this.body.x -10,this.body.y,3);
                     monster.changeImages2();
                     break;
            case 4 : monster = new Monster(this.body.x -10,this.body.y,4);
                     monster.changeImages2();
                     break;
            case 5 : monster = new Monster(this.body.x -10,this.body.y,5);
                     monster.changeImages2();
                     break;
            case 6 : monster = new Monster(this.body.x -10,this.body.y,6);
                     monster.changeImages2();
                     break;       
        }
    }
